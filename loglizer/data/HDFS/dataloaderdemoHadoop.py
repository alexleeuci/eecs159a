...
def load_generalFile(log_dir, label_file=None, window='session', train_ratio=0.5, split_type='sequential', save_csv=False, window_size=0):
    ...
    for subdir, dirs, files in os.walk(log_dir):
        for log_file in files:
            print(log_file)
            if log_file.endswith('.csv') and 0:
                ...
                print("=====struct_log=====")
                print(struct_log,type(struct_log))
                print("=====\n")
                print("===== rows in struct =====")
                #here, all we need is:
                #data_dict[identifier] = [eventID]
                #
...
#out= load_HDFS("HDFS_demo.csv","anomaly_label_demo.csv")
#out= load_HDFS("../Hadoop_2k.log_structured.csv")
out= load_HDFS("../to_process","anomaly_label.csv")
print("=====out=====")
print(out[0][0])
print(out[0][1])
print("=====2=====")
