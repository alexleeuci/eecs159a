...
class LogClusteringOriginal(object):

    def __init__(self, max_dist=0.3, anomaly_threshold=0.3, dimensionality, reductionMode, linkageMode, max_cluster=-1, mode='online'):
        """
        Attributes
        ----------
